...
RNMPBP On REC entry, the values of the following registers are preserved:
...
RHLFRY REC entry fails if ICH\_LR&lt;n&gt;\_EL2.HW == '1' for any implemented value of n .
...
RFGQXT On REC exit, the values of the following registers are preserved:
