...
| vdev_2_gran_sta te   | pre: post:   | GranuleAt(vdev_2_ptr).state != GRAN_VDEV result.status == RMI_ERROR_INPUT   |
|----------------------|--------------|-----------------------------------------------------------------------------|
| vdev_2_realm         | pre: post:   | vdev_2.realm != rd result.status == RMI_ERROR_INPUT                         |
| vdev_2_pdev          | pre: post:   | vdev_2.pdev != pdev_2_ptr result.status == RMI_ERROR_INPUT                  |
| vdev_2_state         | pre: post:   | vdev_2.vdev_state != VDEV_STARTED result.status == RMI_ERROR_DEVICE         |
| vdev_2_comm          | pre: post:   | vdev_2.comm_state != DEV_COMM_IDLE result.status == RMI_ERROR_DEVICE        |
| vdev_2_p2p_boun d    | pre: post:   | vdev_2.p2p_bound != FEATURE_TRUE result.status == RMI_ERROR_DEVICE          |
| vdev_2_p2p_peer      | pre: post:   | vdev_2.p2p_peer != vdev_1.vdev_id result.status == RMI_ERROR_DEVICE         |

## B4.5.89.2.1 Failure condition ordering

vdev\_2\_realm

## DRAFT [feat] &lt; [rd\_align, rd\_bound, rd\_state, pdev\_1\_align, pdev\_1\_bound, pdev\_1\_gran\_state, pdev\_2\_align, pdev\_2\_bound, pdev\_2\_gran\_state, vdev\_1\_align, vdev\_1\_bound, vdev\_1\_gran\_state, vdev\_1\_realm, vdev\_1\_pdev, vdev\_1\_state, vdev\_1\_comm, vdev\_1\_p2p\_bound, vdev\_1\_p2p\_peer, vdev\_2\_align, vdev\_2\_bound, vdev\_2\_gran\_state, vdev\_2\_realm, vdev\_2\_pdev, vdev\_2\_state, vdev\_2\_comm, vdev\_2\_p2p\_bound, vdev\_2\_p2p\_peer] vdev\_2\_pdev vdev\_2\_state vdev\_2\_comm vdev\_2\_p2p\_bound vdev\_2\_p2p\_peer B4.5.89.3 Success conditions

feat rd\_align

rd\_bound rd\_state

pdev\_1\_align pdev\_1\_bound

pdev\_1\_gran\_state pdev\_2\_align

pdev\_2\_bound pdev\_2\_gran\_state

vdev\_1\_align vdev\_1\_bound

vdev\_1\_gran\_state vdev\_1\_realm

vdev\_1\_pdev vdev\_1\_state

vdev\_1\_comm vdev\_1\_p2p\_bound

vdev\_1\_p2p\_peer vdev\_2\_align

vdev\_2\_bound vdev\_2\_gran\_state
