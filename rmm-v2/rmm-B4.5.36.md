...
| feat         | pre: Rmm().static.feat_da != FEATURE_TRUE                                          |
|--------------|------------------------------------------------------------------------------------|
...
| ID                | Condition                                                                             |
|-------------------|---------------------------------------------------------------------------------------|
| state             | post: stream.state == PDEV_STREAM_KEY_PURGING                                         |
