...
* gerr_irq
  * pre: VSMMU has asserted GERROR interrupt.
  * post: (flags.irq == RMI_TRUE && msi_addr == vsmmu.msi_config.gerr_addr && msi_data == vsmmu.msi_config.gerr_data)
* priq_irq
  * pre: VSMMU has asserted PRIQ interrupt.
  * post: (flags.irq == RMI_TRUE && msi_addr == vsmmu.msi_config.priq_addr && msi_data == vsmmu.msi_config.priq_data)
