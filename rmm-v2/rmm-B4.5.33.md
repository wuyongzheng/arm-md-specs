...
```
ID Condition PDEV_STREAM_DISCONNECTING
```

```
connected pre: stream.state == PDEV_STREAM_CONNECTING post: stream.state == PDEV_STREAM_CONNECTED disconnected pre: stream.state == post: stream.state == PDEV_STREAM_DISCONNECTED
```
