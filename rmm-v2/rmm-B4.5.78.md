...
| out_count | X3         | 63:0   | DRAFT UInt64     | RMI_ADDR_TYPE_LIST then this value is zero.                                                                                                                                                                                                                                                                                                                                                                                           |
...
DRAFT B4.5.78.2.1 Failure condition ordering The RMI\_RTT\_UNPROT\_UNMAP command does not have any failure condition orderings. B4.5.78.3 Success conditions ID Condition walk\_pre.rtte.addr
