...
This instruction multiplies corresponding floating-point elements of the first and second source vectors, subtracts the products from 2.0 without intermediate rounding, and places the results in the corresponding elements of the destination vector. This instruction is unpredicated.
...
```
FPRecipStepFused(element1, element2, FPCR);
```