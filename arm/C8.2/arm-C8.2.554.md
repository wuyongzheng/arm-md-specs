...
This instruction computes the absolute difference between odd-numbered signed elements of the second source vector and corresponding elements of the first source vector, and destructively adds to the overlapping double-width elements of the addend vector. This instruction is unpredicated.
