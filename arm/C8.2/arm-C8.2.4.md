## C8.2.4 ADD (vectors, predicated)

Add (predicated)

This instruction adds active elements of the second source vector to the corresponding elements of the first source vector and destructively places the results in the corresponding elements of the first source vector. Inactive elements in the destination vector register remain unmodified.
