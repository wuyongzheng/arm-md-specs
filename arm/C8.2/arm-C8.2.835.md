## C8.2.835 UMLSLB (indexed)

Unsigned multiply-subtract long by indexed element (bottom)

This instruction multiplies the even-numbered unsigned elements within each 128-bit segment of the first source vector by the specified unsigned element in the corresponding second source vector segment and destructively subtracts from the overlapping double-width elements of the addend vector.
