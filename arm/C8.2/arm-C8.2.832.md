## C8.2.832 UMLALT (vectors)

Unsigned multiply-add long (top)

This instruction multiplies the corresponding odd-numbered unsigned elements of the first and second source vectors, and destructively adds to the overlapping double-width elements of the addend vector. This instruction is unpredicated.
