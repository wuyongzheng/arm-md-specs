## C8.2.156 FADD (vectors, unpredicated)
...
```
CheckSVEEnabled(); constant integer VL = CurrentVL; constant integer elements = VL DIV esize; constant bits(VL) operand1 = Z[n, VL]; constant bits(VL) operand2 = Z[m, VL]; bits(VL) result; for e = 0 to elements-1 constant bits(esize) element1 = Elem[operand1, e, constant bits(esize) element2 = Elem[operand2, e, Elem[result, e, esize] = FPAdd(element1, element2, Z[d, VL] = result;
```
