...
This is a pseudo-instruction of V ACGT. This means:

- The encodings in this description are named to match the encodings of V ACGT.
- The assembler syntax is used only for assembly, and is not used on disassembly.
- The description of V ACGT gives the operational pseudocode, any CONSTRAINED UNPREDICTABLE behavior, and any operational information for this instruction.
...
The description of V ACGT gives the operational pseudocode for this instruction.
