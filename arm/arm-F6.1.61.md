...
```
size == 01) VCVT{<c>}{<q>}.U32.F16 <Sd>, <Sm>
```
...
```
size == 01) VCVT{<c>}{<q>}.S32.F16 <Sd>, <Sm>
```

## Encoding for the Single-precision scalar variant

```
Applies when (opc2 == 100 && size == 10) VCVT{<c>}{<q>}.U32.F32 <Sd>, <Sm>
```

## Encoding for the Single-precision scalar variant

```
Applies when (opc2 == 101 && size == 10) VCVT{<c>}{<q>}.S32.F32 <Sd>, <Sm>
```
...
```
(opc2 == 100 && size == 11) VCVT{<c>}{<q>}.U32.F64 <Sd>, <Dm>
```

## Encoding for the Double-precision scalar variant

```
Applies when (opc2 == 101 && size == VCVT{<c>}{<q>}.S32.F64 <Sd>, <Dm>
```
