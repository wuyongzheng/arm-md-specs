...
```
for e = 0 to elements-1 constant bits(8) element1 = Elem[operand1, 2 * e + 1, 8]; constant bits(8) element2 = Elem[operand2, 2 * e + 1, 8]; constant bits(16) element3 = Elem[operand3, e, 16]; Elem[result, e, 16] = FP8MulAddFP(element3, element1, element2, FPCR, Z[da, VL] = result;
```
