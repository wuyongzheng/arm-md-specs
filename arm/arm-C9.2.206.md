## C9.2.206 SMIN (multiple and single vector)

Multi-vector signed minimum by vector

This instruction determines the signed minimum of elements of the second source vector and the corresponding elements of the two or four first source vectors and destructively places the results in the corresponding elements of the two or four first source vectors.
