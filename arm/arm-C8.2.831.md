## C8.2.831 UMLALB (indexed)

Unsigned multiply-add long by indexed element (bottom)

This instruction multiplies the even-numbered unsigned elements within each 128-bit segment of the first source vector by the specified unsigned element in the corresponding second source vector segment and destructively adds to the overlapping double-width elements of the addend vector.
