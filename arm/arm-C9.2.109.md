## C9.2.109 FMOP4A (widening, 2-way, FP16 to FP32)
...
```
FMOP4A <ZAda>.S, <Zn>.H, { <Zm1>.H-<Zm2>.H }
```
...
```
FMOP4A <ZAda>.S, { <Zn1>.H-<Zn2>.H }, <Zm>.H
```
...
```
FMOP4A <ZAda>.S, { <Zn1>.H-<Zn2>.H }, { <Zm1>.H-<Zm2>.H }
```
