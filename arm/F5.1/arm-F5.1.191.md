...
```
if ConditionPassed() then EncodingSpecificOperations(); constant integer diff1 = SInt(R[n]<15:0>) SInt(R[m]<15:0>); constant integer diff2 = SInt(R[n]<31:16>) SInt(R[m]<31:16>); R[d]<15:0> = diff1<16:1>; R[d]<31:16> = diff2<16:1>;
```
