## C8.2.597 SMLALB (indexed)

Signed multiply-add long by indexed element (bottom)

This instruction multiplies the even-numbered signed elements within each 128-bit segment of the first source vector by the specified signed element in the corresponding second source vector segment and destructively adds to the overlapping double-width elements of the addend vector.
