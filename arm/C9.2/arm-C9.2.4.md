## C9.2.4 ADD (to array, multiple vectors)

Multi-vector add to ZA array vectors

This instruction adds all the corresponding elements of the two or four second source vectors and first source vectors and places the results in the corresponding elements of the ZA single-vector groups.
