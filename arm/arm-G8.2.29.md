## G8.2.29 COSPRCTX, Clear Other Speculative Prediction Restriction by Context
...
This system instruction is present only when FEAT\_AA32 is implemented and FEAT\_SPECRES2 is implemented. Otherwise, direct accesses to COSPRCTX are UNDEFINED.
