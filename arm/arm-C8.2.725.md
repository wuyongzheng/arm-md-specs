## C8.2.725 ST1W (scalar plus vector)
...
```
64-bit scaled offset (FEAT_SVE) 1 1 1 31 29 0 0 1 0 28 25 1 0 24 23 0 1 22 21 Zm 20 16 1 0 1 15 13 Pg 12 10 Rn 9 5 Zt 4 0 msz Encoding ST1W { <Zt>.D }, <Pg>, [<Xn|SP>, <Zm>.D, LSL #2] Decode for this encoding if !IsFeatureImplemented(FEAT_SVE) then EndOfDecode(Decode_UNDEF); constant integer t = UInt(Zt); constant integer n = UInt(Rn); constant integer m = UInt(Zm); constant integer g = UInt(Pg); constant integer esize = 64; constant integer msize = 32; constant integer offs_size = 64; constant boolean offs_unsigned = TRUE; constant integer scale = 2; 64-bit unscaled offset (FEAT_SVE) 1 1 1 31 29 0 0 1 0 28 25 1 0 24 23 0 0 22 21 Zm 20 16 1 0 1 15 13 Pg 12 10 Rn 9 5 Zt 4 0 msz Encoding ST1W { <Zt>.D }, <Pg>, [<Xn|SP>, <Zm>.D]
```
