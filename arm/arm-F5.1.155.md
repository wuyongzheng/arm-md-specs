...
Saturating Subtract 8 performs four 8-bit integer subtractions, saturates the results to the 8-bit signed integer range -2 7 &lt;= x &lt;= 2 7 - 1, and writes the results to the destination register.
