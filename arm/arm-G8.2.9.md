...
This system instruction is present only when FEAT\_AA32EL2 is implemented. Otherwise, direct accesses to ATS12NSOPR are UNDEFINED.
...
```
else UNDEFINED; elsif PSTATE.EL == EL2 then AArch32.AT(R[t], TranslationStage_12, EL1, ATAccess_Read); elsif PSTATE.EL == EL3 then AArch32.AT(R[t], TranslationStage_12, EL1, ATAccess_Read);
```