## C8.2.877 UQSUB (vectors, predicated)

Unsigned saturating subtract (predicated)

This instruction subtracts active unsigned elements of the second source vector from corresponding unsigned elements of the first source vector and destructively places the results in the corresponding elements of the first source vector. Each result element is saturated to the N-bit element's unsigned integer range 0 to (2 N )-1. Inactive elements in the destination vector register remain unmodified.
