...
```
if ConditionPassed() then EncodingSpecificOperations(); constant bits(32) rotated = ROR(R[m], R[d]<15:0> = ZeroExtend(rotated<7:0>, 16); R[d]<31:16> = ZeroExtend(rotated<23:16>, 16);
```
