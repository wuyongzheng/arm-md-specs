...
Floating-point round to 64-bit integer, rounding toward zero (predicated)

This instruction rounds to integral floating-point values that fit into a 64-bit integer size using the round towards zero rounding mode from each active floating-point element of the source vector, and places the results in the corresponding elements of the destination vector.
