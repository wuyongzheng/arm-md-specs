...
```
constant integer element2 = SInt(Elem[operand2, s, esize]); constant integer res = 2 * element1 * element2; Elem[result, e, esize] = SignedSat(res >> esize, esize); Z[d, VL] = result;
```
