## C9.2.271 SUB (to array, multiple vectors)

Multi-vector subtract to ZA array vectors

This instruction subtracts all the corresponding elements of the two or four second source vectors from first source vectors and places the results in the corresponding elements of the ZA single-vector groups.
