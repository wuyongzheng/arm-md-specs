...
For the 'Half-precision' variant: is the immediate index, in the range 0 to 7, encoded in the 'i3h:i3l' fields. For the 'Single-precision' variant: is the immediate index, in the range 0 to 3, encoded in the 'i2' field.
