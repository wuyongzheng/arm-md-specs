...
```
Applies when (Q == 0) VMINNM{<q>}.<dt> <Dd>, <Dn>, <Dm>
```
...
```
(FEAT_FP16) Applies when (size == 01) VMINNM{<q>}.F16 <Sd>, <Sn>, <Sm> // (Cannot be
```
...
```
VMINNM{<q>}.F32 <Sd>, <Sn>, <Sm> // (Cannot be
```
...
```
Applies when (size == 11) VMINNM{<q>}.F64 <Dd>, <Dn>, <Dm> // (Cannot be conditional)
```
...
```
VMINNM{<q>}.F16 <Sd>, <Sn>, <Sm> // (Not permitted in IT
```
...
```
Applies when (size == 10) VMINNM{<q>}.F32 <Sd>, <Sn>, <Sm> // (Not permitted in IT block)
```
...
```
VMINNM{<q>}.F64 <Dd>, <Dn>, <Dm> // (Not permitted in IT
```
