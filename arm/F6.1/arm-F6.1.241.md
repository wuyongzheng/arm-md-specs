...
```
1111) VST3{<c>}{<q>}.<size> <list>, [<Rn>{:<align>}]
```

## Encoding for the Post-indexed variant

```
Applies when (Rm == 1101) VST3{<c>}{<q>}.<size> <list>, [<Rn>{:<align>}]!
```
...
```
(Rm != 11x1) VST3{<c>}{<q>}.<size> <list>, [<Rn>{:<align>}], <Rm>
```
