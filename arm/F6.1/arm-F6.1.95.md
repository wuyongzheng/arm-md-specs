...
```
(FEAT_FP16) Applies when (size == 01) VFNMS{<c>}{<q>}.F16 <Sd>, <Sn>, <Sm>
```
...
```
Applies when (size == 11) VFNMS{<c>}{<q>}.F64 <Dd>, <Dn>, <Dm>
```
...
```
(size == 01) VFNMS{<c>}{<q>}.F16 <Sd>, <Sn>, <Sm>
```

## Encoding for the Single-precision scalar variant

```
Applies when (size == 10) VFNMS{<c>}{<q>}.F32
```
