...
```
Applies when (op == 0 && sz == 0) VCVTB{<c>}{<q>}.F32.F16 <Sd>, <Sm>
```
...
```
Applies when (op == 0 && sz VCVTB{<c>}{<q>}.F64.F16 <Dd>, <Sm>
```
...
```
Applies when (op == 1 && sz VCVTB{<c>}{<q>}.F16.F32 <Sd>, <Sm>
```
...
```
(op == 1 && sz VCVTB{<c>}{<q>}.F16.F64 <Sd>, <Dm>
```
...
```
Applies when (op == 0 && sz VCVTB{<c>}{<q>}.F32.F16 <Sd>, <Sm>
```
...
```
(op == 0 && sz VCVTB{<c>}{<q>}.F64.F16 <Dd>, <Sm>
```
...
```
Applies when (op == 1 && sz VCVTB{<c>}{<q>}.F16.F64 <Sd>, <Dm>
```
