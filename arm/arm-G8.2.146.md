## G8.2.146 TLBIIPAS2IS, TLB Invalidate by Intermediate Physical Address, Stage 2, Inner Shareable
...
This system instruction is present only when FEAT\_AA32EL2 is implemented. Otherwise, direct accesses to TLBIIPAS2IS are UNDEFINED.
