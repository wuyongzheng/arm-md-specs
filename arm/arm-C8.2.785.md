## C8.2.785 SUBR (vectors)

Reversed subtract (predicated)

This instruction performs a reversed subtraction on active elements of the first source vector from the corresponding elements of the second source vector and destructively places the results in the corresponding elements of the first source vector. Inactive elements in the destination vector register remain unmodified.
