...
```
if size == '11' then SEE "Related encodings"; if Vd<0> == '1' || (op == '1' && Vn<0> == '1') then UNDEFINED; constant boolean unsigned = (U == '1'); constant boolean is_vaddw = (op == '1'); constant integer esize = 8 << UInt(size); constant integer d = UInt(D:Vd); constant integer n = UInt(N:Vn); constant integer m = UInt(M:Vm); constant integer elements = 64 DIV esize;
```
...
```
if size == '11' then SEE "Related encodings"; if Vd<0> == '1' || (op == '1' && Vn<0> == '1') then constant boolean unsigned = (U == '1'); constant boolean is_vaddw = (op == '1'); constant integer esize = 8 << UInt(size); constant integer d = UInt(D:Vd); constant integer n = UInt(N:Vn); constant integer m = UInt(M:Vm); constant integer elements = 64 DIV esize;
```
