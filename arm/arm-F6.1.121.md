...
```
(FEAT_FP16) Applies when VMLA{<c>}{<q>}.F16 <Sd>, <Sn>, <Sm>
```

## Encoding for the Single-precision scalar variant

```
Applies when (size == 10) VMLA{<c>}{<q>}.F32 <Sd>, <Sn>, <Sm>
```

## Encoding for the Double-precision scalar variant

```
Applies when (size == 11) VMLA{<c>}{<q>}.F64 <Dd>, <Dn>,
```
...
```
Applies when (size == 11) VMLA{<c>}{<q>}.F64 <Dd>, <Dn>, <Dm>
```
