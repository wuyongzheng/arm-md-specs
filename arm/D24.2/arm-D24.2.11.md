## D24.2.11 AFSR1\_EL2, Auxiliary Fault Status Register 1 (EL2)
...
When FEAT\_VHE is implemented MRS &lt;Xt&gt;, AFSR1\_EL1
...
```
if ELIsInHost(EL2) then X[t, 64] = AFSR1_EL2; else X[t, 64] = AFSR1_EL1; elsif PSTATE.EL == EL3 then X[t, 64] = AFSR1_EL1;
```

When FEAT\_VHE is implemented MSR AFSR1\_EL1, &lt;Xt&gt;
