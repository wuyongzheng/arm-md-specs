...
```
if ConditionPassed() then EncodingSpecificOperations(); CheckCryptoEnabled32(); constant bits(128) operand1 = Q[d>>1]; constant bits(128) operand2 = Q[m>>1]; Q[d>>1] = AESSubBytes(AESShiftRows(operand1 EOR operand2));
```
