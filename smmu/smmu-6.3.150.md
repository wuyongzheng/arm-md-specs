## 6.3.150 SMMU\_R\_EVENTQ\_IRQ\_CFG2

The SMMU\_R\_EVENTQ\_IRQ\_CFG2 characteristics are:
...
This register is present only when SMMU\_R\_IDR0.MSI == 1. Otherwise, direct accesses to SMMU\_R\_EVENTQ\_IRQ\_CFG2 are RES0.

## Attributes

SMMU\_R\_EVENTQ\_IRQ\_CFG2 is a 32-bit register.
...
## Accessing SMMU\_R\_EVENTQ\_IRQ\_CFG2

SMMU\_R\_EVENTQ\_IRQ\_CFG2 is Guarded by SMMU\_R\_IRQ\_CTRL.EVENTQ\_IRQEN, and must only be modified when SMMU\_R\_IRQ\_CTRL.EVENTQ\_IRQEN == 0.

See SMMU\_R\_GERROR\_IRQ\_CFG0 for detailed behavior.

Accesses to this register use the following encodings:

Accessible at offset 0x00BC from SMMUv3\_R\_PAGE\_0
