...
The SMMU\_S2PII characteristics are:
...
This register is present only when SMMU\_IDR3.S2PI == 1. Otherwise, direct accesses to SMMU\_S2PII are RES0.

## Attributes

SMMU\_S2PII is a 64-bit register.
...
Accessible at offset 0x0030 from SMMUv3\_PAGE\_0
