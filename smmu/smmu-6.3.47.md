## 6.3.47 SMMU\_DPT\_BASE\_CFG

The SMMU\_DPT\_BASE\_CFG characteristics are:
...
This register is present only when SMMU\_IDR3.DPT == 1. Otherwise, direct accesses to SMMU\_DPT\_BASE\_CFG are RES0.

## Attributes

SMMU\_DPT\_BASE\_CFG is a 32-bit register.
...
- An address size that exceeds the DPT region size configured in SMMU\_DPT\_BASE\_CFG.DPTPS.
...
## Accessing SMMU\_DPT\_BASE\_CFG

Accesses to this register use the following encodings:

Accessible at offset 0x0208 from SMMUv3\_PAGE\_0
