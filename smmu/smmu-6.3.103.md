## 6.3.103 SMMU\_S\_VATOS\_CTRL

The SMMU\_S\_VATOS\_CTRL characteristics are:
...
This register is present only when SMMU\_IDR0.VATOS == 1 and SMMU\_S\_IDR1.SEL2 == 1. Otherwise, direct accesses to SMMU\_S\_VATOS\_CTRL are RES0.

## Attributes

SMMU\_S\_VATOS\_CTRL is a 32-bit register.
...
This register has a similar encoding and behavior to SMMU\_S\_GATOS\_CTRL, except it applies to the Secure Virtual ATOS interface. See Chapter 9 Address Translation Operations for details.
...
## Accessing SMMU\_S\_VATOS\_CTRL
...
Accessible at offset 0x0A00 from SMMUv3\_S\_VATOS
