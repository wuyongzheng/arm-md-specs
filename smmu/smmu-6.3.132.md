## 6.3.132 SMMU\_R\_S2PII

The SMMU\_R\_S2PII characteristics are:
...
This register is present only when SMMU\_IDR3.S2PI == 1. Otherwise, direct accesses to SMMU\_R\_S2PII are RES0.

## Attributes

SMMU\_R\_S2PII is a 64-bit register.
...
This field is indexed by the PIIndex value derived from a stage 2 Block or Page descriptor, as S1PII[PIIndex*4+3 : PIIndex*4] to give a permission interpretation.
...
Accessible at offset 0x0030 from SMMUv3\_R\_PAGE\_0
