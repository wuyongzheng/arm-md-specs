## 6.3.163 SMMU\_R\_CMDQ\_CONTROL\_PAGE\_BASE&lt;n&gt;, n = 0 - 255

The SMMU\_R\_CMDQ\_CONTROL\_PAGE\_BASE&lt;n&gt; characteristics are:
...
This register is present only when SMMU\_R\_IDR0.ECMDQ == 1. Otherwise, direct accesses to SMMU\_R\_CMDQ\_CONTROL\_PAGE\_BASE&lt;n&gt; are RES0.

## Attributes

SMMU\_R\_CMDQ\_CONTROL\_PAGE\_BASE&lt;n&gt; is a 64-bit register.
...
|----------------------------|------------------------------------------------------------------------------------------|
| 0b1                        | The Realm state ECMDQ interfaces for this page are implemented as registers in the SMMU. |

This bit is 1 in this revision of the architecture.

## Accessing SMMU\_R\_CMDQ\_CONTROL\_PAGE\_BASE&lt;n&gt;

Accesses to this register use the following encodings:

Accessible at offset 0x4000 + (32 * n) from SMMUv3\_R\_PAGE\_0
